...
static const rule_t rules[] = {
    ...
    {"what can you do", "I can chat, answer simple math, tell jokes, and share Wii facts!"},
    ...
    {"joke", "Why did the Wii cross the road? To get to the other disc drive!"},
    {"another joke", "My favorite exercise is Wii-Fit-ing more rules into tiny RAM."},
    {"favorite game", "My favorite game is... chatting with you on this TV!"},
    ...
    {"disc", "Yep--this app boots from burned DVD-R. Plug and play!"},
    {"dvd", "DVD-R homebrew is possible with the right softmod or modchip setup."},
    {"boot", "I boot straight from disc--no WiFi, no internet, just pure Wii."},
    ...
    {"see you", "See you later! Pop the disc back in anytime."},
    {"creator", "Built for carterobviously-creator with Wii homebrew style."},
    {"keyboard", "Use D-pad to move, A to type, B to delete, + to send!"},
    {"ai", "I'm a lightweight rule-based AI tuned for Wii-era hardware."},
    {"offline", "Yep! I work 100% offline. No WiFi needed, just burn and go."},
    {"usb", "USB keyboards could work too with libogc USB HID support!"},
};
